...
public class Permanent extends Employee implements AllowanceService {
    ...
    public Permanent(int empNo, String fullName, LocalDate hireDate, EmployeeType status, double salary, Insurance insurance, Overtime overtime, Operational operational, Tax tax) {
